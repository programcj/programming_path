 ...
 */
static char *_dgst_get_val(char *parameter)
{
	char *cursor, *q;
 ...
 */
int _check_string(const char *string)
{
 ...
 */
static char *_crop_sentence(const char *header_value)
{
 ...
 */
static inline int _split_string_by_comma(char *sentence, char **values, int max_values)
{
	int i = 0;
 ...
 */
static inline unsigned int _tokenize_sentence(char *sentence, char **values, unsigned int max_values)
{
	unsigned int i = 0;

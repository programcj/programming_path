...
/*
 * QOS=1 : wait PUBACK 报文是对 QoS 1 等级的 PUBLISH 报文的响应
 *
 */
int mqtt_publish_data(mqtt_broker_handle_t* broker, const char* topic, const void* data, int dlen, uint8_t retain, uint8_t qos, uint16_t* message_id);
